...
RSpec.describe BusOperatorsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(:get => "/bus_operators/new").to route_to("bus_operators#new")
    end
    ...
    it "routes to #create" do
      expect(:post => "/bus_operators").to route_to("bus_operators#create")
    end
    ...
    it "routes to #destroy" do
      expect(:delete => "/bus_operators/1").to route_to("bus_operators#destroy", :id => "1")
    end
